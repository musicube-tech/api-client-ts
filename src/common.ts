...
export const ERROR_INVALID_PUBLIC_RECORDING_INIT_FILE_UPLOAD = Symbol(
  'INVALID_PUBLIC_RECORDING_INIT_FILE_UPLOAD',
);
...
export const ERROR_INVALID_REFERRERS_RESPONSE = Symbol(
  'INVALID_REFERRERS_RESPONSE',
);
export const ERROR_INVALID_USER_FOLDERS_RESPONSE = Symbol(
  'INVALID_USER_FOLDERS_RESPONSE',
);
export const ERROR_INVALID_SIGNUP_NEW_EMAIL = Symbol(
  'INVALID_SIGNUP_NEW_EMAIL',
);
export const ERROR_UNAUTHORIZED = Symbol('UNAUTHORIZED');

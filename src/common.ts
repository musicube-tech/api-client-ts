...
export const ERROR_INVALID_SHOWCASE_SEARCH_ALL_RESPONSE = Symbol(
  'INVALID_SHOWCASE_SEARCH_ALL_RESPONSE',
);
export const ERROR_INVALID_SHOWCASE_SEARCH_FILTERS_RESPONSE = Symbol(
  'INVALID_SHOWCASE_SEARCH_FILTERS_RESPONSE',
);
export const ERROR_INVALID_SHOWCASE_COMPLETE_ARTIST_NAME_RESPONSE = Symbol(
  'INVALID_SHOWCASE_COMPLETE_ARTIST_NAME_RESPONSE',
);
